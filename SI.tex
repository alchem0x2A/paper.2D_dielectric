...
%
%2. Supplementary Section \ref{epsilon-model}: $\varepsilon^{\parallel, \perp}_{\mathrm{SL}}$ dependence on $L$ \\ 
%
...
the 2H-MoS$_{2}$ slab in main text Figure 1a. The
...
\begin{figure}[htbp]
 ...
 \caption{$\Delta \rho$ as a function of $z$ around the
   ...
   \ref{main-fig-1}a. Green and red parts corresponding to negative and
...
\begin{figure}[htbp]
 ...
 \caption{Variation of dielectric properties and
   ...
   $L$. \textbf{a}. $\alpha_{\mathrm{2D}}^{\parallel}$ as function of
   $L$ corresponding to
   \textbf{b}. \textbf{c}. $\varepsilon_{\mathrm{SL}}^{\perp}$ as
...
\ref{main-eq:alpha-perp-ref}, yielding lattice-independent
polarizabilities throughout the frequency domain.
...
\begin{figure}[H]
 ...
 \caption{Dependence of in-plane dielectric properties on $L$ for
   ...
   $\varepsilon_{\mathrm{SL}}^{\parallel}$, \textbf{d} Imaginary part of
   $\alpha_{\mathrm{2D}}^{\parallel}$.  The same {\bf k}-sampling is used
   in all simulations with the only variable quantity being $L$. }
...
We note that the result may change slightly when G$_{0}$W$_{0}$ method
...
\begin{figure}[H]
 ...
 \includegraphics[width=0.9\linewidth]{img/SI-GW-omega-in_plane.pdf}
  \caption{Similar to Figure \ref{fig:PBE-omega-in} but calculated using G$_{0}$W$_{0}$ method. Peak shift can be observed in the dielectric function spectra.
}
...
\begin{figure}[H]
 ...
 \caption{Similar to Figure \ref{fig:PBE-omega-out} but calculated
   using G$_{0}$W$_{0}$ method. Peak shift can be observed in the
...
\begin{figure}[H]
 ...
 \includegraphics[width=0.9\linewidth]{img/SI-BSE-in_plane.pdf}
  \caption{Similar as in Fig. \ref{fig:GW-omega-in} but taking into account electron-hole interactions at the level of 
  the Bethe-Salpeter equation (G$_{\rm 0}$W$_{0}$ - BSE). 
  The peak shift in energies are reduced in comparison with G$_{\rm 0}$W$_{0}$.
}
...
\begin{figure}[H]
 ...
 \includegraphics[width=0.9\linewidth]{img/SI-BSE-out_of_plane.pdf}
  \caption{Similar as in Fig. \ref{fig:GW-omega-out} but taking into account electron-hole interactions at the level of 
  the Bethe-Salpeter equation (G$_{\rm 0}$W$_{0}$ - BSE). 
  The peak shift in energies are reduced in comparison with G$_{\rm 0}$W$_{0}$, HSE06 and PBE but still present. 
}
...
Ref. \citenum{Jiang_2017_Eg_Eb}, the coefficient between
...
\label{sec:raw}
\todo[inline]{I think showing the $\alpha$ values is enough since
  whoever interested in calculating the $r_{0}$ values can simply
  multiply them by $2 \pi$. }
\input{raw_data}
