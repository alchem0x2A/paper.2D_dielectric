...
\begin{figure}[H]
  ...
  \caption{\label{fig-emt} \textbf{Failure of the effective 2D
    ...
    of /ab initio/ $\varepsilon_{\mathrm{SL}} - L$ data for selected
    2D metal dichacolgenides. The uncertainty of
...
\caption{\label{fig-4} \textbf{Application of 2D polarizability to
    multilayer and 3D systems}.  \textbf{a}. Scheme for the 2D-3D
...
\begin{figure}[H]
  \centering
  \includegraphics[width-0.8\linewdith]{img/fig-ellipsoid.pdf}
  \caption{\label{fig-ellip} \textbf{Geometric representation of the
    ...
    $r_{0}^{\parallel}$ and $r_{0}^{\perp}$ for selected 2D metal
    dichalcogenides are shown in \textbf{b} and \textbf{c},
    respectively.  }
\end{figure}
